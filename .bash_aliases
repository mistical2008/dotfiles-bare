...
alias pomogoro="pomogoro config $XDG_CONFIG_HOME/pomogoro/config.toml"
alias pomtodo="pomogoro config $XDG_CONFIG_HOME/pomogoro/config.toml"
...
alias VW='nvim +VimwikiUISelect'
alias VWJ='nvim +VimwikiDiaryIndex'
